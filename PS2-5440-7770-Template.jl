...
begin
	include("C:/Users/jianx/OneDrive/Desktop/Alison School/PS2/src/Include.jl")
	reaction_array = Array{String,1}()
		...
		push!(reaction_array, "v5, 2*L-arginine+3*NADPH+3*H(plus)+4*O2, 2*L-citrulline+2*Nitric oxide+3*NADP(plus)+4*H2O, true")
		...
		push!(reaction_array, "b5, Phosphate, ∅, false")
		push!(reaction_array, "b6, ∅, ATP, false")
		push!(reaction_array, "b7, AMP, ∅, false")
		push!(reaction_array, "b8, ∅, 3*NADPH, false")
		push!(reaction_array, "b9, 2*Nitric oxide, ∅, false")
		push!(reaction_array, "b10, ∅, H2O, false")
		push!(reaction_array, "b11, Diphosphate, ∅, false")
		push!(reaction_array, "b12, ∅, 3*H(plus), false")
		push!(reaction_array, "b13, ∅, 4*O2, false")
		push!(reaction_array, "b14, 3*NADP(plus), ∅, false")
		push!(reaction_array, "b15, 4*H2O, ∅, false")
...
html"""
<p style="font-size:20px;">Alison Shweh</br>
...
# ╔═╡ d376b99a-de6b-43b3-aa97-55f790c7703f
#checking each index in array P for nonzero to calculate # of extreme pathways that produce Urea & reaction frequencies
P[2, 7]

# ╔═╡ 1e8c881e-b6fc-4242-b631-feb59887ce33
html"""
<p style="font-size:20px;">There are 6 extreme pathways. </br>
Counting the number of rows in P that have nonzero numbers in the Urea Column, 4 of the extreme pathways produce Urea. </br> </br> Reaction Frequencies: </br> v1 = 0.5 </br> v2 = 0.5 </br>v3 = 0.33 </br> v4 = 0.33 </br> Fv5 = 0.5 </br> Rv5 = 0.17 </br> b1 =0.33 </br> b2 = 0.17 </br> b3 =0.5 </br>b4 = 0.33</br>b5 = 0.33 </br> b6 = 0.5 </br> b7 = 0.5 </br> b8 =  0.33 </br> b9 = 0.33 </br> b10 = 0.33 </br> b11 =0.5  </br> b12 =0.33  </br> b13 = 0.33 </br> b14 = 0.33  </br> b15 = 0.33   </p>
"""
...
# ╔═╡ a546c8ab-68e5-456b-9a35-0cd79c9594a5
html"""
<p style="font-size:20px;">Rank: H2O, L-citrulline, L-arginine, H(plus), NADP (plus), NADPH, Nitric oxide, O2, 2-(Nomega-L-arginino)succinate, AMP, ATP, Carbamoyl-Phosphate, Diphosphate, Fumarate, K-ornithine, Phosphate, Urea, Aspartate, L-aspartate   </p>
"""
...
# ╔═╡ 37469639-29d5-4046-bdae-81155cc47447
html"""
<p style="font-size:20px;">Rank: Fv5, Rv5, v1, v3, v4, v2, b1, b2, b3, b4, b5, b6, b7, b8, b9, b10, b11, b12, b13, b14, b15    </p>
"""

# ╔═╡ 2da30ff9-c587-4e6a-93e5-3d333ac88ea3
html"""
<p style="font-size:20px;">There is no correlation between reaction connectivity and extreme pathway reaction frequency when comparing the ranking of reactions of the two arrays (P and RCA).  </p>
"""
...
# ╔═╡ 42a90774-9692-4891-b2fe-f70db7e626a7
diag(MCA)
...
# ╔═╡ 7ce73738-9ae0-40c5-ac68-ce6594bd9402
diag(RCA)
